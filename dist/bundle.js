...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stickieList = __webpack_require__(180);

	var _stickieList2 = _interopRequireDefault(_stickieList);
	...
	var pubnub = __webpack_require__(168).init({
	...
	var CollabStickies = function (_React$Component) {
	  _inherits(CollabStickies, _React$Component);

	  function CollabStickies(props) {
	    _classCallCheck(this, CollabStickies);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CollabStickies).call(this, props));
	  ...
	  _createClass(CollabStickies, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      pubnub.subscribe({
	        ...
	        message: function message(m) {
	          return _this2.success(m);
	        },
	        presence: function presence(m) {
	          return _this2.presenceChanged(m);
	        }
	      });
	    }
	    ...
	    value: function connect() {
	      ...
	      pubnub.history({
	        ...
	        callback: function callback(m) {
	          ...
	          try {
	            for (var _iterator = m[0][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	              var v = _step.value;

	              var newList = _this3.state.stickieList.concat(v);
	              _this3.setState({ stickieList: newList });
	            }
	          } catch (err) {
	    ...
	    key: 'presenceChanged',
	    value: function presenceChanged(m) {
	      var _this4 = this;
	    ...
	    value: function getUserList(m) {
	      ...
	      try {
	        for (var _iterator2 = m.uuids[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	          var u = _step2.value;
	          // ES6 for-of loop
	          ...
	          pubnub.state({ //get state
	            ...
	            callback: function callback(s) {
	              ...
	              var newList = _this5.state.userList.concat({ username: s.username, color: s.color, timestamp: s.timestamp });

	              if (i == m.uuids.length) _this5.setState({ userList: newList });
	            }
	          });
	          i++;
	        }
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_userList2.default, { userList: this.state.userList }),
	        _react2.default.createElement(StickieWritable, { username: this.props.username, color: this.props.color }),
	        _react2.default.createElement(_stickieList2.default, { stickieList: this.state.stickieList })
	      );
	    }
	  }]);
	...
	_reactDom2.default.render(_react2.default.createElement(CollabStickies, { username: username, color: color }), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stickie = function (_React$Component) {
	  _inherits(Stickie, _React$Component);

	  function Stickie() {
	    _classCallCheck(this, Stickie);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Stickie).apply(this, arguments));
	  }

	  _createClass(Stickie, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stickie = __webpack_require__(179);
	...
	var StickieList = function (_React$Component) {
	  ...
	  function StickieList() {
	    _classCallCheck(this, StickieList);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(StickieList).apply(this, arguments));
	  }

	  _createClass(StickieList, [{
	    key: 'render',
	    value: function render() {
	      var items = (this.props.stickieList || []).map(function (item) {
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(_stickie2.default, { text: item.text, color: item.color, username: item.username })
	          )
	        );
	      });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          this.props.userList.map(function (item) {
	            return _react2.default.createElement(
	              'li',
	              { key: item.username, className: item.color, title: item.username },
	              _react2.default.createElement(
	                'p',
	                null,
	                item.username
